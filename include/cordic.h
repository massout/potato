...
float cordic_sin(int theta, char iterations) {
    int sin, _cos;

    cordic_sincos(theta, iterations, &sin, &_cos);

    return sin;
}

float cordic_cos(int theta, char iterations) {
    int _sin, cos;

    cordic_sincos(theta, iterations, &_sin, &cos);
